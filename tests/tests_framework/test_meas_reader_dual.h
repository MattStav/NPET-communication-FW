...
// combine_mtx_/pending_start_/pending_stop_/active_legs_/stop_sign_/matchMeasurement()/finishLeg()
// are protected on DualMeasReader; expose them for direct inspection/manipulation in tests. This
// lets the matching/finishing/reset logic be exercised without a live MeasReader, which combine()
// itself needs (and which requires real hardware or a virtual-machine connection to construct).
