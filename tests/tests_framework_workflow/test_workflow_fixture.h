...
// that includes this header get their own instance of this setup/teardown cycle, since GoogleTest
// scopes SetUpTestSuite()/TearDownTestSuite() per fixture class, not per translation unit;
